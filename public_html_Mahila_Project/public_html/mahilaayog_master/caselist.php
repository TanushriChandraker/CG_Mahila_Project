					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo htmlentities($row['complaintstype']);?></td>
								<td><?php echo htmlentities($row['comname']);?></td>
								...
								<a href="caselist.php?cdel=<?= ($row['id']);?>&action=del"><input type="button" class="btn btn-danger" value="Delete Case"></a>
