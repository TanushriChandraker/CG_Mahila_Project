...
include "include/config.php";
    ...
    if (empty($comname)) {
      ...
      if($complaint == "yes"){
        $query = mysqli_query($conn, "insert into cases(caseid,casepws,complaint,comname,comadd,comtele,commob,commail,vicname,vicadd,victele,vicmob,vicmail,relation,district,accname,accuadd,acctele,accmob,accumail,crimedate,complaintstype,subject,casedefi,year,files,ipaddress,Is_Active,created_at) values($caseid,'$casepws','$complaint','$comname','$comadd','$comtele','$commob','$commail','$comname','$comadd','$comtele','$commob','$commail','$relation','$district','$accname','$accadd','$acctele','$accmob','$accumail','$crimedate','$complaintstype','$subject','$casedefi','$year','$file','$ipaddress','$status','$created_at')");
        if($query){
            $file = explode(",", $file);
        ...
        $query = mysqli_query($conn, "insert into cases(caseid,casepws,complaint,comname,comadd,comtele,commob,commail,vicname,vicadd,victele,vicmob,vicmail,relation,district,accname,accuadd,acctele,accmob,accumail,crimedate,complaintstype,subject,casedefi,year,files,ipaddress,Is_Active,created_at) values($caseid,'$casepws','$complaint','$comname','$comadd','$comtele','$commob','$commail','$vicname','$vicadd','$victele','$vicmob','$vicmail','$relation','$district','$accname','$accadd','$acctele','$accmob','$accumail','$crimedate','$complaintstype','$subject','$casedefi','$year','$file','$ipaddress','$status','$created_at')");
        if($query){
            $file = explode(",", $file);
            foreach($file as $key => $singleFile){
...
?>
    <div class="row">
      ...
      <div class="col-10 col-s-9">
          ...
          <div class="form-head">
            ...
            <div class="first_row_form">
              ...
              <div class="victim">
                ...
                <input type="text" id="vicname" name="vicname" placeholder="पीड़ित का नाम" disabled="disabled">
                <textarea style="margin-top: 10px;" id="vicadd" name="vicadd" rows="3" placeholder=" पीड़ित का पता" disabled="disabled"></textarea>
                <input type="number" id="victele" name="victele" placeholder="पीड़ित का दूरभाष" disabled="disabled">
                <input type="number" id="vicmob" name="vicmob" placeholder="पीड़ित का मोबाईल" disabled="disabled">
                <input type="email" id="vicmail" name="vicmail" placeholder="पीड़ित का ई-मेल" disabled="disabled">
        ...
        <label for="">अन्य विवरण संलग्न करे:</label>
