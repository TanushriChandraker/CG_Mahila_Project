  ...
  <div class="row">
  	...
  	<div class="col-10 col-s-9">
  		...
  		<div class="photo-gallery">
  			<?php
				$query="select * from imagegallery order by id desc";
				$result = mysqli_query($conn,$query);
				while($row=mysqli_fetch_array($result))
				{
				?>
			<div>
				<a href="mahilaayog_master/upload/imagegallery/<?php echo htmlentities($row['files']);?>" data-title="<?php echo htmlentities($row['imagecat']);?>" data-lightbox="mygallery"><img src="mahilaayog_master/upload/imagegallery/<?php echo htmlentities($row['files']);?>" alt=""></a>
			</div>
			<?php
 			} ?>
  		</div>
